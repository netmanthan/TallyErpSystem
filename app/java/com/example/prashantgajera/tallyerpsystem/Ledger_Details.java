...
public class Ledger_Details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle("Ledger Details");
    ...
    private void initComponent() {
        ...
        else if(!value)
        {
           ...
           try {
               ...
               byte[] a = null;
               FileSaveInStorage fileSaveInStorage=new FileSaveInStorage("Ledger.json",a);
               sharedPreferences = getSharedPreferences("mypref",MODE_PRIVATE);
               String mypath =sharedPreferences.getString("LedgerPath",null);
               jsonObject = fileSaveInStorage.RetriveFile(mypath);
               LedgerJson(jsonObject);
           }
           catch (Exception e)
           {
               e.printStackTrace();
    ...
    private void JsonData(final List<LedgerCatagory> ledgerCatagory) {
        ...
        acdialog = new ACProgressFlower.Builder(Ledger_Details.this)
        ...
        httpClient = new AsyncHttpClient();
            ...
            httpClient.post(MycommonUtilities.ledgerjsonurl, new JsonHttpResponseHandler(){
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                if(haveStoragePermission()) {
                    ...
                    editor.putString("LedgerPath",mypath);
                    editor.apply();
                }
                LedgerJson(response);
            }
    ...
    public void LedgerJson(JSONObject jsonObject)
    {
        ...
        try {
            ...
            for (int i=1;i<TallyMessage.length();i++) {
                ...
                String parent = MyLedger.getString("PARENT").trim();
                JSONObject attributes = MyLedger.getJSONObject("@attributes");
                String name = attributes.getString("NAME").trim();
                CompanyName=name;
                String OpeningBalance = MyLedger.optString("OPENINGBALANCE").trim();
            ...
            adapterLedgerdetails = new AdapterLedgerdetails(Ledger_Details.this, ledgerCatagory);
            recyclerView.setAdapter(adapterLedgerdetails);
            Toast.makeText(Ledger_Details.this, "", Toast.LENGTH_SHORT).show();
            ...
            adapterLedgerdetails.setOnItemClickListener(new AdapterLedgerdetails.OnItemClickListener() {
                ...
                public void onItemClick(View view, LedgerCatagory obj, int position) {
                    ...
                    try {
                        ...
                        JSONObject attributes = MyLedger.getJSONObject("@attributes");
                        String name = attributes.getString("NAME").trim();
                        String ledger = MyLedger.toString();
                        Log.d("string size",ledger.length()+"// "+ledger);
                        Intent intent = new Intent(Ledger_Details.this,Ledger_Profile.class);
                        intent.putExtra("LedgerProfile",ledger);
